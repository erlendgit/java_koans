...
public class AboutExceptions {
    ...
    private String returnStatementsEverywhere(StringBuilder whatHappened) {
        try {
            ...
            // DO NOT DO THIS!
            // EM: It is simply not intended to be used in that way. I dont feel a need to do so ;-)
            //     It is intended to clean up stuff even if an error occurs.
            return "from finally";
        }
    }
