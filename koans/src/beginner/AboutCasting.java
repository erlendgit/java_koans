...
public class AboutCasting {
    ...
    public void forceIntTypecast() {
        ...
        //   Answer: Weird things happen. Don't do it. The Java compiler will not help you here.
        int b = (int) a;
    ...
    public void upcastWithInheritance() {
        ...
        // Answer: child inherits from Parent.
    ...
    public void upcastAndPolymorphism() {
        ...
        // EM: I guess typecasting is about interfaces most of the time.
    }
    ...
    public void downcastWithInheritance() {
        ...
        // Answer: Because Parent and Grandparent do not inherit from Child.
    ...
    public void downcastAndPolymorphism() {
        ...
        // Answer: Yes, for typecasting, formaly, is about Interfaces.
        // How is that different from above?
        // Answer: it is not, it still is about Interfaces.
    ...
    public void classCasting() {
        try {
            ...
            // Answer: Yes, any.
            // This error proves that typecasting is about interfaces from the compiler perspective.
            // Maybe it can be done with operator overrides? Or is that only C++?
        }
    }
