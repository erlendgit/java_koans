...
public class AboutStrings {
    ...
    public void implicitStrings() {
        ...
        assertSame("just a plain ole string".getClass(), new String().getClass());
    }
    ...
    public void newStringIsRedundant() {
        ...
        assertNotSame(stringInstance, stringReference);
    }
    ...
    public void insufficientArgumentsToStringFormatCausesAnError() {
        try {
            ...
            // Thanks! https://stackoverflow.com/questions/49142268/how-to-get-a-class-as-a-first-class-object?noredirect=1
